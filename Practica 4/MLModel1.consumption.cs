...
namespace Practica_4
{
    public partial class MLModel1
    {
        ...
        public class ModelInput
        {
            ...
            public float ID_Estudiante { get; set; }
            ...
            public float Ranking_Acad_mico { get; set; }

            [LoadColumn(4)]
            [ColumnName(@"Horas_Sue�o")]
            public float Horas_Sue_o { get; set; }

            [LoadColumn(5)]
            [ColumnName(@"Nivel_Estr�s")]
            public float Nivel_Estr_s { get; set; }

            [LoadColumn(6)]
            [ColumnName(@"�xito_Acad�mico")]
            public float __xito_Acad_mico { get; set; }
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"�xito_Acad�mico")]
            public uint __xito_Acad_mico { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("�xito_Acad�mico");
            if (labelColumn == null)
            {
                throw new Exception("�xito_Acad�mico column not found. Make sure the name searched for matches the name in the schema.");
            }
